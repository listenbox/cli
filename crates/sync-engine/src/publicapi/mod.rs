...
#[derive(Debug)]
pub enum CreateSyncEpisodeDeletionResponse {
    Status202(CreatedPublicEpisodeDeletion),
    Status400(ValidationErr),
    Status401(()),
    Status402(()),
...
#[derive(Clone, Debug)]
pub struct GetEpisodeOrderParams {
    pub show_slug: ShowSlug,
}

#[derive(Debug)]
pub enum GetEpisodeOrderResponse {
    Status200(EpisodeOrder),
    Status400(ValidationErr),
    Status401(()),
    Status403(()),
    Status404(()),
...
pub struct GetSyncInventoryParams {
    pub show_slug: ShowSlug,
    pub cursor: std::option::Option<EpisodeID>,
    pub limit: std::option::Option<EpisodePageLimit>,
}

#[derive(Debug)]
pub enum GetSyncInventoryResponse {
    Status200(SyncInventory),
    Status400(ValidationErr),
    Status401(()),
    Status402(()),
    Status403(()),
...
pub enum ListClientTeamsResponse {
    Status200(std::vec::Vec<ClientTeam>),
    Status400(ValidationErr),
    Status401(()),
    Status403(()),
    Unexpected(reqwest::Response),
...
#[derive(Clone, Debug)]
pub struct SetEpisodeOrderParams {
    pub show_slug: ShowSlug,
    pub body: SetEpisodeOrder,
}

#[derive(Debug)]
pub enum SetEpisodeOrderResponse {
    Status200(EpisodeOrder),
    Status400(ValidationErr),
    Status401(()),
    Status402(()),
...
pub struct SyncInventory {
    #[serde(rename = "episodes")]
    pub episodes: std::vec::Vec<SyncEpisode>,
    #[serde(rename = "next_cursor", default, skip_serializing_if = "Option::is_none")]
